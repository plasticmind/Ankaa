...
module.exports = {
	...
	// Project options.
	projectURL: 'http://local.plasticmind.com/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'PM', // Your textdomain here.
	packageName: 'PM', // Package name.
	bugReport: 'https://plasticmind.com/contact/', // Where can users report bugs.
	team: 'Jesse Gardner <jesse@plasticmind.com>', // Team's Email ID.
